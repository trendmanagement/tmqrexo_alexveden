...
class StrategyPointAndFigurePatterns_DynamicBoxSize(StrategyBase):
    def __init__(self, strategy_context):
        ...
        self.name = 'PointAndFigurePatterns_DynamicBoxSize'
    ...
    def calculate(self, params=None, save_info=False):
        ...
        if params is None:
            ...
            direction, atr_period, reversal_multiplier, window_percent, column_consec_move_count, rules_index, period_median = self.default_opts()
        else:
            # Unpacking optimization params
            #  in order in self.opts definition
            direction, atr_period, reversal_multiplier, window_percent, column_consec_move_count, rules_index, period_median = params
        ...
        # Enry/exit rules
        entry_rule = self.calc_entry_rules(atr_period, reversal_multiplier, window_percent, column_consec_move_count,
                                           rules_index)
