...
STRATEGY_SUFFIX = 'alt2-bullish-'

STRATEGY_CONTEXT = {
    'strategy': {
        'class': StrategyIchimokuCloud,
        'exo_name': 'ZC_CallSpread',        # <---- Select and paste EXO name from cell above
        'opt_params': [
                        ...
                        OptParamArray('RulesIndex', [7,8,9]),
                        #OptParamArray('RulesIndex', [10,11,12,13]), # 7,9
                        OptParam('MedianPeriod', 5, 33, 33, 13)
            ],
    },
    'swarm': {
        'members_count': 2,
