...
#        Created at: 2016-12-22 09:38:56.262832
#
...
STRATEGY_CONTEXT = {
    ...
    'strategy': {
        ...
        'opt_params': [
            ...
            OptParam('conversion_line_period', 9, 2, 31, 13), 
            OptParam('base_line_period', 26, 26, 26, 13), 
            OptParam('leading_spans_lookahead_period', 26, 26, 26, 10), 
            OptParam('leading_span_b_period', 52, 13, 39, 13), 
            OptParamArray('RulesIndex', [13, 10, 0, 1]), 
