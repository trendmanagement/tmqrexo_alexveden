...
class SmartEXO_SWP_DeltaTargeting_1X1_Bi_2_3_2_2_neutralOnly3X2_call_side(SmartEXOSwingpoint):

    # Change the EXO name to reflect SmartEXO behavior
    EXO_NAME = 'SmartEXO_SWP_DeltaTargeting_1X1_Bi_2_3_2_2_neutralOnly3X2_call_side'
